...
public class GameServiceTest {
    ...
    void createGameTestPositive() throws UnauthorizedException, DataAccessException {
    ...
    void listGamesTestPositive() throws UnauthorizedException, DataAccessException {
        int gameID1 = gameService.createGame(authData.authToken());
        int gameID2 = gameService.createGame(authData.authToken());
    ...
    void joinGameTestNegative() throws UnauthorizedException, DataAccessException {
        int gameID = gameService.createGame(authData.authToken());
    ...
    void clearTestPositive() throws UnauthorizedException, DataAccessException {
    ...
    void clearTestNegative() throws UnauthorizedException, DataAccessException {
        gameService.createGame(authData.authToken());
